...
public final class CatzConstants {
 ...
 //Saving for finished trajectory planner
  ...
  //-----------------------------Intake------------------------------------------
    ...
    //----------------------------------------------------------------------------------------------
    private static final int    WRIST_ENC_CAN_ID = 13; 


    private static final double ENC_TO_INTAKE_GEAR_RATIO =  46.0/18.0;
    ...
    public static final double INTAKE_PICKUP_CONE_ENC_POS_GROUND =  -184.524 + WRIST_ABS_ENC_OFFSET_DEG;//-306.0  + WRIST_ABS_ENC_OFFSET;  //-1295  
    public static final double INTAKE_PICKUP_CONE_ENC_POS_SINGLE =  -116.400 + WRIST_ABS_ENC_OFFSET_DEG;//2089.0 + WRIST_ABS_ENC_OFFSET;  //1100
...
//-------------------------------Elevator-------------------------------------------------------
    ...
    public final double MAX_MANUAL_SCALED_POWER = 0.7;

    public final double MANUAL_CONTROL_DEADBAND = 0.1;

    public final double MANUAL_CONTROL_PWR_OFF = 0.0;
    ...
    public static final double POS_ENC_INCH_LOW  = 0.0;
    public static final double POS_ENC_INCH_MID_CONE  = 39.616;
    public static final double POS_ENC_INCH_MID_CUBE  = 26;
    public static final double POS_ENC_INCH_HIGH = 47.187;

    public static final double POS_ENC_CNTS_LOW  = POS_ENC_INCH_LOW * ELEVATOR_INCHES_TO_COUNTS_CONVERSTION_FACTOR;
    public static final double POS_ENC_CNTS_MID_CONE  = POS_ENC_INCH_MID_CONE * ELEVATOR_INCHES_TO_COUNTS_CONVERSTION_FACTOR;//91000.0;// needs to be lower...too high
    // private final double POS_ENC_CNTS_MID_CUBE  = POS_ENC_INCH_MID_CUBE * INCHES_TO_COUNTS_CONVERSTION_FACTOR;
    public static final double POS_ENC_CNTS_MID_CUBE = 50000.0;
    public static final double POS_ENC_CNTS_SINGLE_PICKUP = 27739;

    public static final double POS_ENC_CNTS_HIGH = POS_ENC_INCH_HIGH * ELEVATOR_INCHES_TO_COUNTS_CONVERSTION_FACTOR;//111200.0;
    ...
    public static final double ARM_ENCODER_THRESHOLD = 35000.0;

    public static final double HOLDING_FEED_FORWARD = 0.044;


    public static final double CLOSELOOP_ERROR_THRESHOLD_LOW = 50; 
    // private final double CLOSELOOP_ERROR_THRESHOLD_HIGH_MID = 300; 
    public static final double CLOSELOOP_ERROR_THRESHOLD_HIGH_MID = 225; 
    ...
    private static final double ARM_FINAL_RATIO   = VERSA_RATIO * PUILEY_RATIO;
